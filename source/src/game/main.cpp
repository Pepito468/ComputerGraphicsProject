...
CookTorranceMaterial* brickMat = new CookTorranceMaterial({1.0f, 1.0f, 1.0f}, {1.0f, 1.0f, 1.0f, 100.0f},"brick.png");
...
Node* createForestScene() {
    ...
    Model3D* statue = new Model3D("Statue.gltf", {20, -3, 82}, {M_PI/2, 0, M_PI/4}, VEC3_ONE * 8.0f, brickMat);
    models->adopt(statue);
