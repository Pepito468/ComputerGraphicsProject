    ...
    public:
        ...
        void loadNode(Node *node) {
            ...
            if (Model3D *model = dynamic_cast<Model3D*>(node)) {
                ...
                renderer.createDirectionalLight(light->radiance, light->color, light->direction);
                ...
                renderer.addSpotLight(light->getGlobalPosition(), light->radiance, light->color, light->aperture, light->decay, light->direction);
            }
